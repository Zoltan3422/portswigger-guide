"use strict";
/*
Thu May 04 2023 17:17:05 GMT+0200 (Central European Summer Time)
...
var SettingsPanel = () => {
  ...
  }, "You have unsaved changes.")), /* @__PURE__ */ import_react9.default.createElement(SettingItemControl, null, /* @__PURE__ */ import_react9.default.createElement(Button, {
    onClick: onRevert
  ...
  applyColorStylesInternal() {
    ...
    fileExplorers.forEach((fileExplorer) => {
      Object.entries(fileExplorer.view.fileItems).forEach(([path, fileItem]) => {
        const itemClasses = fileItem.selfEl.classList.value.split(" ").filter((cls) => !cls.startsWith("file-color"));
